...
## Current Milestone: v1.1 考试情况导出细化 (shipped 2026-05-17)

**Goal:** 在 v1.0 双表 xlsx 导出基础上，于「成绩汇总」表为每位考生增加各题得分列 — **delivered Phase 5**.
...
_None — v1.1 scope delivered in Phase 5._

### Validated (v1.1)

- ✓ **EXPR-03**: 导出「成绩汇总」含每道题得分列（宽表，对齐校方 `test1-成绩导出.xlsx` 用法）— Phase 5
- ✓ **EXPR-04**: 「答题明细」长表与 v1.0 一致 — Phase 5
