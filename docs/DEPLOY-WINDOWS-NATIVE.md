...
“清除全部数据”会删除考试、题库、名单、填空题 / 操作题批次及相关文件，但会保留设置项本身。
...
- 作答页显示距离计划结束时间的倒计时；**到达计划结束时间后系统会自动提交试卷并结束考试**（已保存的客观/填空作答计分，未答按 0 分；未上传的操作题不会自动交卷）
...
- 点击“导出成绩与明细”下载 Excel
- 若考试包含填空题，可点击“导出填空题截图”下载 ZIP（仅含**已交卷**学员的截图；ZIP 内按学员分文件夹 `姓名_身份证后4位`，文件名为 `第一题01`、`第一题02`、`第二题01`…，题号与答题卡一致）
